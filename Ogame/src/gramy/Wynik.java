...
public class Wynik extends JFrame{
	...
	public Wynik(){
		...
		double mojepkt = Stage.GUN_LASER + (2.1*Stage.GUN_ION)+(4*Stage.GUN_GAUSS)+(2.3*Stage.SHIP_CRUISER)+(5*Stage.SHIP_GRENADE)+(15*Stage.SHIP_STAR_DEATH) +(0.01*Stage.LVL_FIGHT)*(0.01*Stage.LVL_PROTECTION) *(Stage.GUN_LASER + (2.1*Stage.GUN_ION)+(4*Stage.GUN_GAUSS)+(2.3*Stage.SHIP_CRUISER)+(5*Stage.SHIP_GRENADE)+(15*Stage.SHIP_STAR_DEATH));
