...
public class Opisy extends JComponent {
	...
	public Opisy(){
		...
		textMetal.setText("Dostawca g³ównego surowca do budowy \nkonstrukcji noœnych budynków i statków kosmicznych.");
		...
		textCristal.setText("Dostawca g³ównego surowca do budowy\n elementów elektronicznych i stopów metali.");
		...
		textDeuterium.setText("Oddziela atomy deuteru(ciê¿kiego izotopu wodoru)\n od atomów lekkiego wodoru z wody znajduj¹cej\n siê na planecie.");
