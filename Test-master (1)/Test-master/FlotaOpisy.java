...
public class FlotaOpisy extends JComponent{
					...
					try{
						int i = Integer.parseInt(buildStarDeath.getText());
							if(Stage.METAL> i*COST_STAR_DEATH_METAL && Stage.CRISTAL > i * COST_STAR_DEATH_KRYSZTAL && Stage.DEUTERIUM > i * COST_STAR_DEATH_DEUTER){
								...
								starDeathLvl.setText("Gwiazda Œmierci " + Stage.SHIP_STAR_DEATH+" sztuk");
							}
	...
	public FlotaOpisy(){
		...
		starDeathLvl = new JLabel("Gwiazda Œmierci "+Stage.SHIP_STAR_DEATH +" sztuk");
	...
	//podmet.setBackground(Color.BLUE);
		...
		textCruiser.setText("Kr¹¿ownik jest œwietnie opancerzony, dysponuje du¿¹\nsi³¹ ognia. W dodatku jest bardzo szybki.");
		...
		textGrenade.setText("Bombowiec zosta³ stworzony, aby niszczyæ systemy\nobronne innych planet.");
		...
		textStarDeath.setText("Gwiazda œmierci jest uzbrojona w ogromne\ndzia³o grawitonowe, które mo¿e niszczyæ statki\ntak du¿e jak niszczyciele a nawet ksiê¿yce.");
