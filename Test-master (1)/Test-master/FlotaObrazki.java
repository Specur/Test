...
public class FlotaObrazki extends JPanel{
	...
	Image img , imgCruiser,imgGrenade,imgStarDeath,metal,cristal,deuterium;
	public FlotaObrazki(){
		
		img =loadImage("background.jpg");
		imgCruiser = loadImage("Krazownik.jpg");
		imgGrenade = loadImage("Babowiec.jpg");
		imgStarDeath = loadImage("GwiazdaSmierci.jpg");
	...
	public void paint(Graphics g){
		...
		g.drawImage(imgCruiser, 300, 150,this);
		g.drawImage(imgGrenade, 300, 270, this);
		g.drawImage(imgStarDeath, 300, 390, this);
